    ...
    public ButtonEditor(JTextField text, JTable table) {
        ...
        button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                fireEditingStopped(); // Stop cell editing when button is clicked
        ...
        // Add mouse listener to handle single clicks
        button.addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                if (e.getClickCount() == 1) {
                    fireEditingStopped(); // Stop cell editing on single click
                }
            }
    ...
    private void addPlayerToTeam(String playerInfo) {
        ...
        try (Connection con = DriverManager.getConnection(jdbcUrl, username, password)) {
            try {
                ...
                if (playerCounter >= 15) {
                    JOptionPane.showMessageDialog(button, "Team have exceeded 15 players. Failed to add players.");
                } else {
                    ...
                    if (result > 0) {
                        ...
                        JOptionPane.showMessageDialog(button, "Player \"" + playerName + "\" added to team.");
                    } else {
